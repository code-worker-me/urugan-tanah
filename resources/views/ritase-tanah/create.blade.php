    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-xl shadow-gray-100/80 overflow-hidden">
                <form action="{{ route('ritase.store', $urugan) }}" method="POST" enctype="multipart/form-data" class="p-6 md:p-8 space-y-7">
                    @csrf
                    ...
                    <div class="space-y-4 pt-2">
                        ...
                        <div id="foto-zone"
                            ...
                            {{-- Default View --}}
                            <div id="foto-default" class="flex flex-col items-center gap-3">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-gray-800 group-hover:text-indigo-600 transition">
                                        Klik untuk upload foto muatan truk
                                    </p>
                            ...
                            {{-- Preview Image View --}}
                            <div id="foto-preview-wrapper" class="hidden flex-col items-center gap-2 relative">
                                <img id="foto-preview" src="#" alt="Preview Foto" class="max-h-48 rounded-xl object-cover shadow-sm border border-gray-200">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            removeBtn.addEventListener('click', (e) => {
                ...
                fotoDefault.classList.remove('hidden');
            });
        });
    </script>
</x-app-layout>
