        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8">
                    ...
                    <form action="{{ route('urugan.store') }}" method="POST"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" id="nama_pt" name="nama_pt"
                                           value="{{ old('nama_pt') }}"
                                           placeholder="Contoh: PT Mayora Tbk."
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="alamat_pt" name="alamat_pt" rows="3"
                                              ...
                                              class="w-full rounded-lg border @error('alamat_pt') border-red-400 bg-red-50 @else border-gray-300 @enderror px-4 py-2.5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition resize-none">{{ old('alamat_pt') }}</textarea>
                                    @error('alamat_pt')
                                        <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                                    @enderror
                                </div>
